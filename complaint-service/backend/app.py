...
CIVICSCORE_SERVICE_URL = "http://localhost:5004"
...
def create_complaint():
    ...
    # Best-effort civic score award — must NOT block or fail the complaint
    try:
        requests.post(
            f"{CIVICSCORE_SERVICE_URL}/score/award",
            json={"citizen_id": citizen_id},
            timeout=3
        )
    except requests.exceptions.RequestException:
        # Civic Score Service being down should never break complaint creation
        pass
